                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="custom-card my-5 mt-md-5">
                            ...
                            <div class="col-lg-4">
                                <div class="row">
                                    <div class="col-12 col-md-6 col-lg-12 d-flex justify-content-center align-items-center mb-lg-5">
                                        <!-- Card vazio para futuras funcionalidades -->
                                        <div class="custom-card" style="height: 225px; width: 18.75rem;">
                                            <!-- Espaço reservado para futuras funcionalidades -->
                                        </div>
                                    </div>

                                    <div class="col-12 col-md-6 col-lg-12 d-flex justify-content-center align-items-center my-5 mt-lg-5">
                                        <!-- Gráfico Circular -->
                                        <div class="custom-card" style="height: 200px; width: 18.75rem;">
